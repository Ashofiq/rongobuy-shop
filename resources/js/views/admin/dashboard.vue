        ...
        <div class="row">
          <div class="col-lg-6 col-xl-3 col-xxl-3 col-md-6">
            <div class="summery-item">
              ...
              <ul>
                <li>
                  <span><i class="bi bi-arrow-up"></i> 30.4%</span> increase
                  this month
                </li>
              </ul>
              <div class="circle">
          ...
          <div class="col-lg-6 col-xl-3 col-xxl-3 col-md-6">
            <div class="summery-item item-2">
              ...
              <ul>
                <li>
                  <span><i class="bi bi-arrow-up"></i> 15.4%</span> increase
                  this month
                </li>
              </ul>
              <div class="circle">
                ...
                <table class="table">
                  ...
                  <tbody style="border-top: 0">
                    ...
                    <tr>
                      ...
                      <td>01/01/2015</td>
                      <td>
                        <span class="released in-progress"
